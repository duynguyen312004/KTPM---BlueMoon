...
INSERT INTO vehicle_fee_mapping (vehicle_type, fee_id) VALUES
                                                           ('MOTORBIKE', 2), -- Phí gửi xe máy (fee_id = 2)
                                                           ('CAR', 3);       -- Phí gửi ô tô (fee_id = 3)
...
INSERT INTO residents (resident_id, household_id, name, birthday, relationship, national_id, phone_number, created_at, updated_at) VALUES
                                                                                                                                       (1, 1, 'Trần Thị Cư Dân', '1985-05-15', 'Chủ hộ', '012345678901', '0901000001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), -- Liên kết với user_id = 3 (resident01)
                                                                                                                                       (2, 1, 'Trần Văn An', '1980-02-20', 'Chồng', '012345678902', '0901000002', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                                                                                                                                       (3, 1, 'Trần Bảo Ngọc', '2010-10-10', 'Con gái', '012345678903', '0901000003', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO residents (resident_id, household_id, name, birthday, relationship, national_id, phone_number, created_at, updated_at) VALUES
                                                                                                                                       (4, 2, 'Lê Văn Bình', '1990-07-25', 'Chủ hộ', '012345678904', '0902000001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                                                                                                                                       (5, 2, 'Phạm Thị Yên', '1992-11-30', 'Vợ', '012345678905', '0902000002', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO batch_fees (batch_id, fee_id,created_at,updated_at) VALUES
                                                                    (2, 1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), (1, 2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), (1, 3,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), (1, 5,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
                                                                    (2, 2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), (1, 2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), (2, 4,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP), (2, 6,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);          -- Đợt 2 không có phí từ thiện
...
INSERT INTO billing_items (household_id, fee_id, batch_id, expected_amount, actual_amount, status, created_at, updated_at) VALUES
                                                                                                                               (1, 1, 2, 151000, 151000, 'Paid', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),    -- QLCC: 75.50 * 2000
                                                                                                                               (1, 2, 2, 100000, 100000, 'Paid', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),    -- Xe Máy
                                                                                                                               (1, 3, 2, 1200000, 0, 'Pending', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),     -- Ô tô (chưa thanh toán)
                                                                                                                               (1, 3, 2, 15000, 15000, 'Paid', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),      -- Nước
                                                                                                                               (1, 3, 2, 50000, 50000, 'Paid', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),      -- Vệ Sinh
                                                                                                                               (1, 3, 2, 20000, 20000, 'Paid', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);      -- Từ Thiện

-- Hộ B205 (id=2), diện tích 90.00 m2, có 1 xe máy. Đợt tháng 06/2024 (batch_id = 1)
INSERT INTO billing_items (household_id, fee_id, batch_id, expected_amount, actual_amount, status, created_at, updated_at) VALUES
                                                                                                                               (2, 1, 2, 180000, 0, 'Pending', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),     -- QLCC: 90.00 * 2000
                                                                                                                               (2, 2, 2, 100000, 0, 'Pending', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),     -- Xe Máy
                                                                                                                               (2, 3, 2, 15000, 15000, 'Paid', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),     -- Nước
                                                                                                                               (2, 3, 2, 50000, 50000, 'Paid', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);     -- Vệ Sinh

-- Hộ C303 (id=3), diện tích 60.25 m2, không có xe. Đợt tháng 07/2024 (batch_id = 2)
INSERT INTO billing_items (household_id, fee_id, batch_id, expected_amount, actual_amount, status, created_at, updated_at) VALUES
                                                                                                                               (3, 4, 2, 120500, 0, 'Pending', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),     -- QLCC: 60.25 * 2000
                                                                                                                               (3, 5, 2, 15000, 0, 'Pending', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),      -- Nước
                                                                                                                               (3,6, 2, 50000, 50000, 'Paid', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);     -- Vệ Sinh
